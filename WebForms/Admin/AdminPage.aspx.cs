    ...
    public partial class AdminPage : System.Web.UI.Page
    {
        ...
        protected void AddProductButton_Click(object sender, EventArgs e)
        {
            ...
            if (fileOk)
            {
                ...
                {
                    LabelAddStatus.Text = "Unable to add new product to datatbase.";
                }
            }
            else
            {
        ...
        {
            var db = new WebForms.Models.ProductContext();
        ...
        protected void RemoveProductButton_Click(object sender, EventArgs e)
        {
            using(var db = new WebForms.Models.ProductContext())
            {
                ...
                if(myItem != null)
                {
                    ...
                    db.SaveChanges();
                    string pageUrl = Request.Url.AbsoluteUri.Substring(0, Request.Url.Query.Count());
